...
const productImages = {
  ...
  "tufted-rugs": [
    ...
    "/rug4.jpeg",
    "/rug5.jpeg",
    "/rug6.jpeg","/rug7.jpeg","/rug8.jpeg","/rug9.jpeg","/rug10.jpeg",
    "/rug11.jpeg","/rug12.jpeg","/rug13.jpeg","/rug14.jpeg","/rug15.jpeg",
    "/PE0014.jpg","PE0010.jpg","/PE005.jpg","/PE009.jpg","/PE0045.jpg",
    "/PE0043.jpg","/PE0033.jpg","/PE0039.jpg","/PE0034.jpg","/PE0032.jpg",
    "/PE0030.jpg","/PE0028.jpg","/PE0025.jpg","/PE0022.jpg","/PE0021.jpg","PE001.jpg","/PE0044.jpg",
  ...
  "tabletufted-bathmats": [
    ...
    "Picture6.jpg",
    "Picture7.jpg",
  "Picture14.png","Picture4.jpg","Picture27.jpg",
  "Picture19.jpg","Picture24.jpg","Picture25.jpg","Picture26.jpg",
  "Picture28.jpg","Picture29.jpg","Picture30.jpg","Picture31.jpg","Picture32.jpg","Picture35.jpg","Picture36.jpg","Picture37.jpg",
  "Picture38.jpg","Picture39.jpg","Picture40.jpg","Picture41.jpg","Picture42.jpg","Picture43.jpg","Picture44.jpg","Picture45.jpg","Picture46.jpg","Picture47.jpg",
  ,"Picture18.png","Picture20.png","Picture23.png","Picture24.png","Picture25.png","Picture26.png",
  "Picture35.png",
    ],
  "woven-cushions": [
    "woven5.jpg",
...
const products = [
  ...
  },
  {
    ...
    tag: "New Arrival",
    description:
      "Stylish and functional tote bags made from high-quality, sustainable materials, perfect for everyday use or special occasions.",
    features: [
  ...
  },
  {
    ...
    tag: "Heritage",
    description:
      "Tufted rugs crafted with precision, combining traditional techniques and modern designs to bring unmatched style and comfort to your space.",
    features: [
      "Handcrafted Quality",
      "Soft and Plush",
      "Variety of Designs",
  ...
  },
  {
    ...
    tag: "Bestseller",
    description:
      "Essential textiles for modern living, including table linen, aprons, and more, crafted for durability and elegance.",
    features: [
      "Premium Cotton",
      "Stain Resistant",
      "Modern Designs",
...
<div className={
    product.image === "public/hand tufted cushions.jpeg"
        ? "w-full md:w-[50%] flex-shrink-0 relative group flex items-center rounded-lg justify-center bg-[#ffffff] overflow-hidden"
        : "w-full md:w-1/2 flex-shrink-0 relative group flex items-center rounded-lg justify-center bg-[#f5deb3] overflow-hidden" // Changed background for others
}>
    <img
        src={product.image}
        alt={product.title}
        className={
            product.image === "public/hand tufted cushions.jpeg"
                ? "h-80 md:h-70 object-cover scale-100 rounded-lg transition-transform duration-500 group-hover:scale-105"
                : "w-full h-80 object-cover rounded-lg transition-transform duration-500 group-hover:scale-105" // Applied h-80 to others
        }
        loading="lazy"
    />
  ...
  <span className="absolute top-4 left-4 bg-yellow-400 text-white text-xs font-semibold px-3 py-1 rounded-full shadow">
    {product.tag}
             ...
             {/* Product Info */}
<CardContent className="flex-1 flex flex-col justify-between p-6 md:p-10 w-full min-w-0">
  <div>
    <h2 className="text-2xl sm:text-3xl font-bold text-[#584130] mb-2">
      {product.title}
    </h2>
    <p className="text-base sm:text-lg text-[#7c6652]  mb-4 font- italic">
      {product.description}
    </p>
  ...
  <div className="flex flex-col sm:flex-row gap-3">
    <Button
      className="group bg-[#7c6652] hover:bg-[#584130] text-[#E5DFBE] px-8 py-3 text-base font-semibold rounded-xl shadow transition-all duration-300 flex items-center justify-center"
    ...
    <Button
      asChild
      className="border-emerald-600 text-[#E5DFBE] bg-green-800 hover:bg-green-700 px-8 py-3 text-base font-semibold rounded-xl shadow transition-all duration-300 flex items-center justify-center"
    >
      <a
        href={product.wa}
        target="_blank"
...
{openIndex !== null && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    ...
    >
      ...
      <p className="text-center text-[#4b341e]">{products[openIndex].description}</p>
